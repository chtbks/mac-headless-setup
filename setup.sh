...
MODULES=(
  ...
  "35-git-lfs|Git LFS filters (Chatbooks Flutter/LFS assets)|35-git-lfs.sh|25-brewfile"
  "40-xcode|Full Xcode via xcodes + license accept|40-xcode.sh|25-brewfile"
  "45-macro-trust|Disable Swift-macro fingerprint validation (headless)|45-macro-trust.sh|00-preflight"
